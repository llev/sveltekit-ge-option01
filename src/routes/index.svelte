<article class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
<h2 class="prose-2xl">Welcome to SvelteKit</h2>
<p>Visit <a href="https://kit.svelte.dev">kit.svelte.dev</a> to read the documentation</p>
<button class="btn btn-success"><a href="https://typeform.com">Typeform</a></button>

<div class="contaier md:container md:mx-auto">
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  ...
  <div class="mx-auto lg:max-w-2xl">
    <div class="relative w-full transition-shadow duration-300 hover:shadow-xl">
      <img class="object-cover w-full h-56 rounded shadow-lg sm:h-64 md:h-80 lg:h-96" src="https://www.gedoormanufacturing.co.uk/user_resources/images/homecasestudy/homecasestudy.png?auto=compress&amp;cs=tinysrgb&amp;dpr=3&amp;h=750&amp;w=1260" alt="" />
      <a href="https://www.youtube.com/watch?v=LOzo1HqpkOY" aria-label="Play Video" class="absolute inset-0 flex items-center justify-center w-full h-full transition-colors duration-300 bg-gray-900 bg-opacity-50 group hover:bg-opacity-25">
